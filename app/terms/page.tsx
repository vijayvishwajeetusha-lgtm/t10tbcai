          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                By accessing and using the T10 Tennis Ball Cricket Association of India (NCCA) website and services, you
              ...
              <p className="text-muted-foreground mb-4">
                ...
                through the designated payment gateway. NCCA is not responsible for any payment issues arising from
                third-party payment processors.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">5. Intellectual Property</h2>
              <p className="text-muted-foreground mb-4">
                All content on this website, including text, graphics, logos, and images, is the property of NCCA and is
                protected by copyright laws. Unauthorized use is prohibited.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">6. Limitation of Liability</h2>
              <p className="text-muted-foreground mb-4">
                NCCA shall not be liable for any injuries sustained during tournaments or events. Participants are
                advised to have appropriate insurance coverage. NCCA is not responsible for any loss or damage to
                personal belongings.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">7. Changes to Terms</h2>
              <p className="text-muted-foreground mb-4">
                NCCA reserves the right to modify these terms at any time. Continued use of our services after changes
